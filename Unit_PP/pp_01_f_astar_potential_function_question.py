...
def astar(start, goal, obstacles):
    ...
    while front:
        ...
        for dx, dy, deltacost in movements:
            ...
            if new_x < 0 or new_y < 0 or new_x > extents[0] -1 or new_y > extents[1] - 1:
                continue
            if visited[new_pos]==0 and obstacles[new_pos]!=255:
                new_total_cost = total_cost+ distance(new_pos, goal) + obstacles[new_pos]/64 +deltacost
                heappush(front, (new_total_cost, cost+deltacost, new_pos, pos))
